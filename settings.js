module.exports = {
  ...
  title: 'St. Louis Ranked Slippi Leaderboard',
  ...
  repoPath: 'https://benfeldhake.github.io/STLSlippiLeaderboard/',

  // Google sheets ID for player connect codes.
  // https://docs.google.com/spreadsheets/d/[YOUR ID]
  spreadsheetID: '1QgDHI5zfg3f02pmRnVVuzSyTUCiVJKTCPgfsU2VSK6A-A',
};
